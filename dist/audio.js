...
/***/ "./src/audio/setOscillatorType.js":
/*!****************************************!*\
  !*** ./src/audio/setOscillatorType.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nvar list = [{\n  name: 'sine',\n  ja: '正弦波'\n}, {\n  name: 'square',\n  ja: '矩形波'\n}, {\n  name: 'sawtooth',\n  ja: 'ノコギリ波'\n}, {\n  name: 'triangle',\n  ja: '三角波'\n}, {\n  name: 'custom',\n  ja: 'カスタム'\n}];\n\nvar setOscillatorType = function setOscillatorType(filter, select) {\n  var ja = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;\n  var custom = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    for (var _iterator = list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      var a = _step.value;\n      if (a.name === 'custom' && custom === false) continue;\n\n      var _option = document.createElement('option');\n\n      _option.value = a.name;\n      _option.innerHTML = ja ? a.ja : a.name;\n      select.appendChild(_option);\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator[\"return\"] != null) {\n        _iterator[\"return\"]();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n\n  var option = _toConsumableArray(select.children).filter(function (a) {\n    return a.value === filter.type;\n  })[0];\n\n  if (option != null) option.selected = true;\n  select.addEventListener('change', function () {\n    var option = select[select.selectedIndex];\n    filter.type = option.value;\n    console.log('===== set filter type ', filter.type, '=====');\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (setOscillatorType);\n\n//# sourceURL=webpack:///./src/audio/setOscillatorType.js?");
